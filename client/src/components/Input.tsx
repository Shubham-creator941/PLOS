...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
 ...
 ref={ref}
 id={id}
 className={`flex h-10 w-full rounded-md border bg-surface-secondary px-3 py-2 text-body text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50 transition-colors ${
 error
