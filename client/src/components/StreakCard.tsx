    ...
    <Card className="hover:-translate-y-[2px] transition-all duration-normal ease-standard hover:shadow-md hover:border-border-hover bg-surface hover:bg-surface-hover">
      <CardContent className="p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-label text-warning-800 dark:text-warning-300">Current Streak</h3>
            <div className="flex items-baseline gap-2 mt-1">
              <span className="text-h2 text-warning-900 dark:text-warning-100">{currentStreak}</span>
              <span className="text-body text-warning-700 dark:text-warning-400">days</span>
            </div>
            <p className="text-caption text-warning-600 dark:text-warning-500 mt-1">Longest: {longestStreak} days</p>
          </div>
        </div>
      </CardContent>
    </Card>
